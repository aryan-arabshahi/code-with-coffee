<section class="container m-auto py-10 mt-6">
    <header>
        <h2 class="text-4xl text-center font-medium">Become A Full Stack Developer</h2>
        <p class="text-lg text-center text-gray-desc my-2">
            Upgrade your skills to be a full stack developer
        </p>
    </header>
