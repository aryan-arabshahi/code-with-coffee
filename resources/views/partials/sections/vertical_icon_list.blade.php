<section class="container relative m-auto py-10 mt-20">
    <header>
        <h2 class="text-4xl text-center font-medium">Sample Projects</h2>
        <p class="text-lg text-center text-gray-desc my-2">
            Projects and ideas for inspiration
        </p>
    </header>
        ...
        <div class="w-1/2 px-12">
            <div class="flex mt-4 bg-white rounded shadow-lg shadow-red border p-2">
                ...
                <article class="w-3/4 pr-4">
                    <h1 class="font-medium my-2">CodeWithCoffee.Dev</h3>
            ...
            <div class="flex mt-4 bg-white rounded shadow-lg shadow-red border p-2">
                ...
                <article class="w-3/4 pr-4">
                    <h1 class="font-medium my-2">Admin.CodeWithCoffee.Dev</h3>
                    <p class="text-sm text-gray-desc leading-6">
                        The codewithcoffee.dev admin panel that implemented with React.
                    </p>
                </article>
            </div>
            <div class="flex mt-4 bg-white rounded shadow-lg shadow-red border p-2 relative">
                ...
                <article class="w-3/4 pr-4">
                    <h1 class="font-medium my-2">DevOpsUtils</h3>
                    <p class="text-sm text-gray-desc leading-6">
